...
for i_episode in itertools.count(1):
    ...
    while not done:
        ...
        writer.add_scalar('Main/step_reward', reward, global_step=episode_steps)
        writer.add_scalar('Main/CL_CD', env.cl_cd, global_step=episode_steps)
        writer.add_scalar('States/XLE1', env.XLE1, global_step=episode_steps)
        writer.add_scalar('States/XLE2', env.XLE2, global_step=episode_steps)
        writer.add_scalar('States/CHORD1_1', env.CHORD1_1, global_step=episode_steps)
        writer.add_scalar('States/CHORD1_2', env.CHORD1_2, global_step=episode_steps)
        writer.add_scalar('States/CHORD2_1', env.CHORD2_1, global_step=episode_steps)
        writer.add_scalar('States/CHORD2_2', env.CHORD2_2, global_step=episode_steps)
        writer.add_scalar('States/SSPAN1_2', env.SSPAN1_2, global_step=episode_steps)
        writer.add_scalar('States/SSPAN2_2', env.SSPAN2_2, global_step=episode_steps)
        state = next_state
